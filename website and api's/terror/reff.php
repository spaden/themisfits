...
<head>
    ...
    <style>
        ...
        .qto1 {
            margin-top: 2.8%;
            background-image: url("http://159.89.161.229/images/adult.jpg");
        ...
        .usdet {
            margin-top: 2.8%;
            background-image: url("http://159.89.161.229/images/kiss.jpg");
            background-size: cover;
        }
...
<body>
    ...
    ?>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12 col-xl-5">
                    <div class="card">
                        <div class="card-body">
                            <img src="http://159.89.161.229/images/beach.jpg" class="rounded att1" alt="Cinque Terre">
                        </div>
            ...
            <div class="row but">
                ...
                <span class="col-md-1 col-lg-1 col-xl-1 but1"><a id="loadme"></a></span>
        ...
        <script>
         ...
         window.onload=function(){
           ...
           document.getElementById("buynow").onclick=function(){
            //   loadme("https://www.amazon.in/Love-patient-its-kind-know-ebook/dp/B07DH3V9RP/ref=sr_1_1?ie=UTF8&qid=1532912767&sr=8-1&keywords=love+is+patient+its+kind");
           // alert("getting");
               //getLocation();
               check();
        ...
        xmlhttp.open("GET", "http://159.89.161.229/terror/reff2.php?usname=" + usname, true);
        xmlhttp.send();
        }
        function check(){
            var usname = document.getElementById("usnames").value;
        ...
        function deject(){
            ...
            cml.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    // alert(this.responseText);
                   loadme("https://www.amazon.in/Love-patient-its-kind-know-ebook/dp/B07DH3V9RP/ref=sr_1_1?ie=UTF8&qid=1533134273&sr=8-1&keywords=love+is+patient+its+kind");      
                }
            };
            cml.open("GET", "http://www.themisfits.in/terror/reff2.php?usname="+usname+"&uemail="+usemail+"&usloc="+uslocation+"&usreff="+usreff+
            "&orreff="+orreff+"&buy="+1, true);
